...
class SampleExchangeDriver implements MarketDataProviderInterface, SupportsPriceSnapshot, SupportsPriceStream
{
    public function __construct(
        private readonly SampleExchangeClient $client,
        private readonly SampleExchangeMapper $mapper,
