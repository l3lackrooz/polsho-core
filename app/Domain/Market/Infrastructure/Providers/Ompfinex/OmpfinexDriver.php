...
class OmpfinexDriver implements MarketDataProviderInterface, SupportsPriceSnapshot
{
    public function __construct(
        private readonly OmpfinexClient $client,
        private readonly OmpfinexMapper $mapper,
